...
def main():
    ...
    max_window          = 10000                     # (int) Ventana de datos para la tasa de aceptación (número de sweeps a considerar para calcular la pendiente de la tasa de aceptación)
    ...
    T_init = 2.10                                           # Temperatura inicial
    T_step = 0.10                                           # Paso de temperatura
    T_max  = 2.40                                           # Temperatura máxima
